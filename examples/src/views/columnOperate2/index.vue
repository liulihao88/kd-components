<template>
  <div>
    <example-title :data="{ title: '表格操作列', maintenance: '刘云' }" warning>
      ...
      当kd-column-operate不能满足需求时，可以考虑使用原生的el-table-column组件去自由发挥，实现一些特殊的需求。<br />
      <br />
      <b>
      ...
      <p slot="warning">
        kd-column-operate2是重构版，原kd-column-operate个别情况下有比较严重的bug（连续多次点击触发popover时，偶发情况下不经二次确认也会执行确认回调）
      </p>
    </example-title>
    ...
    <kd-simple-table :data="tableData" :show-paging="false" row-key="id">
      ...
      <kd-column-operate2 :btn-list="btnList1" label="普通按钮"></kd-column-operate2>
      <kd-column-operate2 :btn-list="btnList2" label="label函数"></kd-column-operate2>
      <kd-column-operate2 :btn-list="btnList3" label="popover按钮"></kd-column-operate2>
      <kd-column-operate2 :btn-list="btnList4" label="按钮禁用"></kd-column-operate2>
      <kd-column-operate2 :btn-list="btnList5" label="按钮占位"></kd-column-operate2>
      <kd-column-operate2 :btn-list="btnList6" label="按钮显示/隐藏"></kd-column-operate2>
      <kd-column-operate2 :btn-list="btnList7" label="dropdown按钮组"></kd-column-operate2>
    </kd-simple-table>
