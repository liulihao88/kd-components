<template>
  <div class="cron-container content">
    <div class="left">
      <el-tabs v-model="curtab" size="small">
        <el-tab-pane v-if="!hideYear && !hideSecond" label="年" name="year">
...
export default {
  ...
  computed: {
    tableData() {
      ...
      return this.hideSecond || this.hideYear
        ? c.concat({ name: '表达式', value: this.cronValue_c })
        : c.concat(
